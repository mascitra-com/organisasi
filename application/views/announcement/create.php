    ...
    <div class="col-md-12">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <form action="<?=site_url('announcement/store')?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body" class="form-control" placeholder="isi pengumuman" value="<?= (isset($announcement['body'])) ? $announcement['body'] : ''; ?>" required></textarea>
                    </div>
                    <div class="row">
