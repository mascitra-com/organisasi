	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 col-sm-4 col-md-4">
				&copy <?=date('Y')?> <a href="http://www.mascitra.com" class="text-info">mascitra.com</a> . All rights reserved 
			</div>
			<div class="col-xs-12 col-sm-8 col-md-8">
				<div class="site-map">
					<a href="<?=site_url('homepage')?>">Beranda</a>
					<a href="<?=site_url('homepage/profile')?>">Profil</a>
					<a href="<?=site_url('homepage/news')?>">Berita</a>
					<a href="<?=site_url('homepage/agenda')?>">Agenda</a>
